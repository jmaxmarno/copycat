...
ap.add_argument('--send_workers', default=2, type=int, help='sender threads doing the TCP forwarding')
...
ap.add_argument('--send_timeout', default=5, type=int, help='seconds allowed per connect+send')
